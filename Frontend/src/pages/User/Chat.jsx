...
import { Send, User, Wrench, Search, MoreVertical, Phone, ArrowLeft, Check, CheckCheck } from 'lucide-react';
...
const Chat = () => {
    ...
    const activeThreadInfo = admins.find(a => a._id === activeThread) || { name: 'Chat', role: 'System' };
        ...
        <div ref={containerRef} className="h-[calc(100vh-170px)] md:h-[calc(100vh-140px)] flex gap-6">
            ...
            <div className={`flex-shrink-0 bg-paper border border-secondary/10 rounded-lg shadow-sm flex flex-col overflow-hidden w-full md:w-80 ${showMobileChat ? 'hidden md:flex' : 'flex'}`}>
                <div className="p-4 border-b border-secondary/10">
                    <h2 className="text-lg font-black text-ink uppercase tracking-tight mb-4">Messages</h2>
            ...
            {/* Chat Area */}
            <div className={`chat-interface opacity-0 flex-1 bg-paper border border-secondary/10 rounded-lg shadow-sm flex-col overflow-hidden ${showMobileChat ? 'flex' : 'hidden md:flex'}`}>
                {/* Chat Header */}
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-[10px] font-bold text-secondary uppercase tracking-wider truncate">SUPPORT ONLINE</span>
                            </div>
                        </div>
                    </div>
                </div>
